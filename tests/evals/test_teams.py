...
class TeamsCompetencyTest(CompetencyTest):
    ...
    def register_mock_responses(self, mcp: MockedMCPServer) -> None:
        ...
        mcp.register_mock_response(
            ...
            {"response": [{"id": "USER123", "name": "Sara Connor",
...
TEAMS_COMPETENCY_TESTS = [
    ...
    TeamsCompetencyTest(
        ...
        expected_tools=[{"tool_name": "list_teams", "parameters": {"query_model": {"query": "Dev Team"}}},
    ...
    TeamsCompetencyTest(
        ...
        expected_tools=[{"tool_name": "create_team",
    ...
    TeamsCompetencyTest(
        ...
        expected_tools=[
            {"tool_name": "list_teams", "parameters": {}}
        ],
    ...
    TeamsCompetencyTest(
        ...
        expected_tools=[
            {"tool_name": "list_teams", "parameters": {"query_model": {"scope": "my"}}}
        ],
